...
## Project Overview
This is a smaller project that I did to assist a professor in his project to predict the "success" of ERC721 tokens (during my Blockchain course). Unfortunately, we did not proceed with the remainder of the project, but I still wanted to show what I did.
